---
title: docker-registry | 搭建与使用
date: 2023-02-19 19:24:19
...

{
    ...
    "insecure-registries":["172.16.2.117:30001"]  # 服务器ip和端口
}
```
...
- 访问：[http://172.16.2.117:30001/v2/_catalog](http://172.16.2.117:30001/v2/_catalog)
```json
{
"repositories": [
]
...
- 上传镜像到仓库
```bash
docker tag frontend_docker:v1 172.16.2.117:30001/frontend_docker:v1  # 打标签
docker push 172.16.2.117:30001/frontend_docker:v1  
...
- 拉取镜像
```bash
docker pull 172.16.2.117:30001/frontend_docker:v1
```
### 在私有仓库上传、搜索、下载镜像
