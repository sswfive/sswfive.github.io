---
title: Docker安装卸载指南
date: 2022-07-07 23:15:13
permalink: /pages/f36fc5/
categories:
  - Docker
tags:
  - docker
...
* 旧版本的 Docker 叫 `<span class="ne-text">docker</span>` 或者 `<span class="ne-text">docker-engine</span>`，现在的版本被称为 `<span class="ne-text">docker-ce</span>`，如果之前安装过，则先卸载掉之前的版本：
