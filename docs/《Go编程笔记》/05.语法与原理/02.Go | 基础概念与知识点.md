---
title: Go | 基础概念与知识点
date: 2023-02-08 22:53:09
permalink: /pages/9c566e/
categories:
  - Go
tags:
  - go
...
![](https://raw.githubusercontent.com/ronin-sswang/upload_notes_img/main/img/202109160045202.png#id=Batj2&originHeight=710&originWidth=1540&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
```go
var 变量名称 数据类型 [ = 变量初始值]             //方式一// fg:var name stringvar 变量名1, 变量名2 <变量类型> = 初始值1,初始值2  //方式二//fg:var a, b = 2, 3var (                                        //方式三    name1 = initialvalue1,    name2 = initialvalue2)
```
...
```go
name := initialvalue//fg:a := 1//多变量b, c := 2, 3name, age := "xiang", 18
```
